...
<head>
    ...
    <title>Reset Password Partner Nexus</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-6">
        <div class="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            <div class="text-center mb-6">
                ...
                <p class="text-sm text-gray-600">Masukkan password baru untuk akun Partner Anda.</p>
            </div>
            ...
            <form method="POST" action="{{ route('diantaranexus.password.store') }}" class="space-y-5">
                @csrf
