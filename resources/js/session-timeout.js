...
class SessionTimeout {
    constructor(timeoutMinutes = 475) { // 475 minutes to match server session timeout (480 minutes = 8 hours)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.querySelector('meta[name="csrf-token"]')) {
        new SessionTimeout(475); // 475 minutes timeout to match server session (8 hours)
    }
});
